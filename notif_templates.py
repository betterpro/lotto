...
VAR_HELP: dict[str, str] = {
    ...
    "shares": "member's shares in the current open round",
    "invite_count": "friends who joined this group through the member's invite link",
    "round": "current group round number",
