...
_SCHEMA_STATEMENTS = [
    ...
    """DO $$ BEGIN
       ...
       END $$""",
    """DO $$ BEGIN
         IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='notification_rules_language_check') THEN
           ALTER TABLE notification_rules ADD CONSTRAINT notification_rules_language_check
